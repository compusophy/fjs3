import {
  ...
  export default async function Home({ searchParams }: NextServerPageProps) {
    ...
    if (previousFrame.postBody?.untrustedData.buttonIndex) {
      await handleFollowRequest(previousFrame.postBody?.untrustedData.buttonIndex);
    }
    ...
    return (
      <div className="p-4">
        frames.js starter kit. The Template Frame is on thi in
        ...
        >
          <FrameImage aspectRatio="1.91:1">
            <div style={{ width: '100%', height: '100%', backgroundColor: 'slategray', color: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
